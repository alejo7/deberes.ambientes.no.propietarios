...
foreach($array as $ind=>$variable)
{
    if(is_array($variable))
    {
        recorrer1($variable);
    }else{
        if($ind!="provincia"and $ind!="canton"){
        
        //echo $variable."  ".$ind.'<br>';
        echo "<option value=\"$ind\">$variable</option>";
        echo "<br />";
...
recorrer1($provincias_cantones_parroquias);
