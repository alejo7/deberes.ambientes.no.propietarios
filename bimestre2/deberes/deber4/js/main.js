...
$(document).ready(function() {
 ...
 //location.reload();
    ...
    .done(function(msg) {
      if(msg=="Mensaje enviado con &eacute;xito.")
...
$(document).on("click","#modificar",function(e)
    {
      ...
      
      {
        ...
        .done(function( msg ) {
            ...
            $("#mensaje_modificacion").html(msg).addClass('alert-success').fadeOut(3000);
        ...
        $("#mensaje_modificacion").html("<p class='alert-danger'>Debes ingresar un valor</p>").fadeOut(3000);
    });
